...
final class CreateBiliLiveDanmu extends AbstractMigration
{
    ...
    public function up()
    {
        ...
        $table->addColumn('danmu_id', 'uuid', ['comment' => '礼物id', 'null' => false])
            ...
            ->addColumn('medal_anchor', 'string', ['comment' => '牌子主播', 'null' => true])
            ->addColumn('medal_name', 'string', ['comment' => '牌子名称', 'null' => true])
            ->addColumn('medal_level', 'integer', ['comment' => '牌子等级', 'null' => true, 'limit' => MysqlAdapter::INT_SMALL])
